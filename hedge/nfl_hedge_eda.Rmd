...
Illustrate difference between profitability target and success needed
...
profit_target / (1 - return)

return = ((success * profit_target() ) - ((1 - success)))

success <- 0.9

return = 0.5success - (1 - success)

return + 1 - success = 0.5success

0.5 success + success = return + 1 

profit_target * (return + 1)
```


# Baseline - bet on the outright winner
