...
odds_df <- odds_df %>% 
  mutate(fav_odd_group = cut(fav_odd, breaks = seq(min_fav_group, max_fav_group, by = interval_amt), right = T),
         und_odd_group = cut(und_odd, breaks= seq(min_und_group, max_und_group, by = interval_amt), right = T))
